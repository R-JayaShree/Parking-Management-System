...
while(resultSet.next()){
    if(resultSet.getString("status").equals("Booked")&&resultSet.getString("status1").equals("Booked")&& resultSet.getString("username1").equals(resultSet.getString("username"))){
%>
<tr>
