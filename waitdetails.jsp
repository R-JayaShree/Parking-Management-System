...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Waitinglistdetails</title>
...
<h1 style="margin-left:35%;margin-top:2%;">Database for Waiting List Details :</h1>
...
while(resultSet.next()){
    if(resultSet.getString("status").equals("Waiting List") && resultSet.getString("status1").equals("Waiting List") && resultSet.getString("username1").equals(resultSet.getString("username"))){
%>
<tr>
<td><%=resultSet.getString("username1") %></td>
